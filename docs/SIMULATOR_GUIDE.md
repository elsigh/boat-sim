# Simulator and build notes

Twin-screw docking practice in real San Juan Islands marinas.

![Plan view of the simulator approaching a marina](images/boat-sim.png)

## The original build story

*This section preserves the motivation as written before the charter.*
...
![Thrustmaster TCA throttle quadrant](images/thrustmaster.png)
