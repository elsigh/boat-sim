...
The canonical production site is https://my-boats.vercel.app. The app and film branding remains boatsim. The other claimed Vercel domains redirect to this address, preserving paths and query strings. Confirm the project domain in Vercel before changing links or rendering a new campaign.
